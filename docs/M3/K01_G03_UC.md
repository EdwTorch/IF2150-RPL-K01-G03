...
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1. | tekan tombol beri ulasan (hanya untuk jasa yang pernah dibeli) | menampilkan laman untuk memberi ulasan (bintang yang diberi dari 5, dokumentasi (opsional), komentar tambahan (opsional)) |
| 2. | memilih jumlah bintang, mengunggah dokumentasi, mengisi komentar tambahan, lalu tekan tombol kirim | validasi kelengkapan pengisian dan kesesuaian kriteria |
| 3. |  | menyimpan ulasan pada database, mengupdate rata-rata bintang pada laman pemilik jasa, dan menampilkan ulasan pada laman jasa |
| 4. |  | menampilkan pesan ulasan sudah diberikan |
---
...
| :--- | :--- | :--- |
| 1. | tekan tombol beri ulasan (hanya untuk jasa yang pernah dibeli) | menampilkan laman untuk memberi ulasan (bintang yang diberi dari 5, dokumentasi (opsional), komentar tambahan (opsional)) |
| 2. | mengisi formulir secara tidak lengkap | validasi kelengkapan pengisian dan kesesuaian kriteria |
| 3. |  | menampilkan pesan error bahwa jumlah bintang tidak dipilih |
| 4. | melengkapi bagian yang belum diisi dan menekan tombol kirim | validasi kelengkapan pengisian dan kesesuaian kriteria |
| 5. |  | menyimpan ulasan pada database, mengupdate rata-rata bintang pada laman pemilik jasa, dan menampilkan ulasan pada laman jasa |
| 6. |  | menampilkan pesan ulasan sudah diberikan |
---

**Skenario Alternatif 2: kriteria dokumentasi tidak sesuai**
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1. | tekan tombol beri ulasan (hanya untuk jasa yang pernah dibeli) | menampilkan laman untuk memberi ulasan (bintang yang diberi dari 5, dokumentasi (opsional), komentar tambahan (opsional)) |
| 2. | memilih jumlah bintang dan mengunggah dokumentasi tidak sesuai kriteria | validasi kelengkapan pengisian dan kesesuaian kriteria |
| 3. |  | menampilkan pesan error bahwa dokumentasi tidak sesuai kriteria, gunakan filetype .jpeg, .jpg, atau .png dan total maksimal 10 MB |
| 4. | menyesuaikan dokumentasi sehingga sesuai dengan kriteria dan menekan tombol kirim | validasi kelengkapan pengisian dan kesesuaian dokumentasi |
| 5. |  | menyimpan ulasan pada database, mengupdate rata-rata bintang pada laman pemilik jasa, dan menampilkan ulasan pada laman jasa |
| 6. |  | menampilkan pesan ulasan sudah diberikan |
---
...
| :--- | :--- | :--- |
| 1. | tekan tombol beri ulasan (hanya untuk jasa yang pernah dibeli) | menampilkan laman untuk memberi ulasan (bintang yang diberi dari 5, dokumentasi (opsional), komentar tambahan (opsional)) |
| 2. | memilih jumlah bintang dan memberikan komentar tidak sesuai kriteria | validasi kelengkapan pengisian dan kesesuaian kriteria |
| 3. |  | menampilkan pesan error bahwa komentar tidak sesuai kriteria, panjang maksimum 300 kata |
| 4. | menyesuaikan komentar sehingga sesuai dengan kriteria dan menekan tombol kirim | validasi kelengkapan pengisian dan kesesuaian dokumentasi |
| 5. |  | menyimpan ulasan pada database, mengupdate rata-rata bintang pada laman pemilik jasa, dan menampilkan ulasan pada laman jasa |
| 6. |  | menampilkan pesan ulasan sudah diberikan |
---
...
| :--- | :--- | :--- |
| 1. | tekan tombol beri ulasan (hanya untuk jasa yang pernah dibeli) | menampilkan laman untuk memberi ulasan (bintang yang diberi dari 5, dokumentasi (opsional), komentar tambahan (opsional)) |
| 2. | memilih jumlah bintang, mengunggah dokumentasi, mengisi komentar tambahan, lalu tekan tombol kirim | validasi kelengkapan pengisian dan kesesuaian dokumentasi |
| 3. |  | menampilkan pesan error "pengiriman ulasan gagal. periksa koneksi internet atau tunggu 10 menit" |
---
...
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1. | admin membuka tiket laporan pada *dashboard* | menampilkan komponen-komponene laporan (kategori pelanggaran, deskripsi masalah, dan lampiran bukti) |
| 2. | menentukan keputusan berdasarkan bukti-bukti yang tersedia | |
| 3. | memilih jenis konsekuensi berdasarkan keputusan, pilihan (tidak ada sanksi, teguran, pembekuan, atau pemblokiran) |  |
| 4. | memencet tombol "Resolve" pada laman tiket laporan | menerapkan sanksi pada penyedia jasa, sesuai dengan keputusan admin (tidak melakukan apapun, mengirimkan notifikasi peringatan pelanggaran kepada akun, menonaktifkan sementara fitur transaksional pada akun, atau mencabut hak akses akun ke dalam platform) |
| 5. |  | mengganti status tiket laporan menjadi "Resolved" pada *database* |
---

**Skenario Alternatif 1: tidak dapat menentukan keputusan**
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1. | admin membuka tiket laporan pada *dashboard* | menampilkan komponen-komponene laporan (kategori pelanggaran, deskripsi masalah, dan lampiran bukti) |
| 2. | menentukan keputusan berdasarkan laporan yang diberikan | |
| 3. | memilih jenis konsekuensi berdasarkan keputusan, pilihan (tidak ada sanksi, teguran, pembekuan, atau pemblokiran) |  |
| 4. | memencet tombol "Resolve" pada laman tiket laporan | menerapkan sanksi pada penyedia jasa, sesuai dengan keputusan admin (tidak melakukan apapun, mengirimkan notifikasi peringatan pelanggaran kepada akun, menonaktifkan sementara fitur transaksional pada akun, atau mencabut hak akses akun ke dalam platform) |
| 5. |  | mengganti status tiket laporan menjadi "Resolved" pada *database* |
---
...
| 2. | menentukan keputusan berdasarkan bukti-bukti yang tersedia | |
| 3. | memilih jenis konsekuensi berdasarkan keputusan, pilihan (tidak ada sanksi, teguran, pembekuan, atau pemblokiran) |  |
| 4. | memencet tombol "Resolve" pada laman tiket laporan | menampilkan pesan error "penyelesaian tiket laporan gagal. periksa koneksi internet atau tunggu 10 menit" |
---
...
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1.  | admin membuka tiket laporan pada *dashboard* dan memilih opsi mediasi | menampilkan antarmuka ruang mediasi antara admin, pengguna jasa, dan penyedia jasa |
| 2.  | admin, pengguna jasa, dan penyedia jasa melakukan obrolan untuk menyelesaikan permasalahan | menyimpan riwayat pesan dan menampilkannya pada layar ruang mediasi |
| 3.  | admin menetapkan keputusan mediasi, memilih jenis konsekuensi berdasarkan keputusan, pilihan (tidak ada sanksi, teguran, pembekuan, atau pemblokiran), dan menekan tombol "Selesai" | menerapkan sanksi pada penyedia jasa, sesuai dengan keputusan admin (tidak melakukan apapun, mengirimkan notifikasi peringatan pelanggaran kepada akun, menonaktifkan sementara fitur transaksional pada akun, atau mencabut hak akses akun ke dalam platform) |
| 4.  |  | menutup ruang mediasi, memperbarui status pesanan, dan menampilkan pesan bahwa proses mediasi telah selesai |
---

**Skenario Alternatif 1: salah satu pihak tidak responsif**
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1.  | admin membuka tiket laporan pada *dashboard* dan memilih opsi mediasi | menampilkan antarmuka ruang mediasi antara admin, pengguna jasa, dan penyedia jasa |
| 2.  | admin mencoba menggali informasi, tetapi salah satu pihak (pengguna jasa atau penyedia jasa) tidak merespons dalam batas waktu yang ditentukan | menyimpan riwayat obrolan pada layar mediasi |
| 3.  | admin menetapkan keputusan mediasi secara sepihak berdasarkan bukti yang sudah ada, memilih jenis konsekuensi berdasarkan keputusan, pilihan (tidak ada sanksi, teguran, pembekuan, atau pemblokiran), dan menekan tombol "Selesai" | menerapkan sanksi pada penyedia jasa, sesuai dengan keputusan admin (tidak melakukan apapun, mengirimkan notifikasi peringatan pelanggaran kepada akun, menonaktifkan sementara fitur transaksional pada akun, atau mencabut hak akses akun ke dalam platform) |
| 4.  |  | menutup ruang mediasi, memperbarui status pesanan, dan menampilkan pesan bahwa proses mediasi telah selesai |
---
...
| :--- | :--- | :--- |
| 1.  | admin membuka tiket laporan pada *dashboard* dan memilih opsi mediasi | menampilkan antarmuka ruang mediasi antara admin, pengguna jasa, dan penyedia jasa |
| 2.  | admin menetapkan keputusan mediasi, memilih jenis konsekuensi berdasarkan keputusan, pilihan (tidak ada sanksi, teguran, pembekuan, atau pemblokiran), dan menekan tombol "Selesai" | menampilkan pesan error "mediasi tidak dapat diselesaikan. periksa koneksi internet atau tunggu 10 menit" |
---
