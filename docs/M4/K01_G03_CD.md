...
| C26 | Pesanan | Menyimpan informasi jasa (brief) yang dipesan pengguna dan konfirmasi Penyedia Jasa | UC09, UC10 |
...
| C29 | HalamanRiwayatTransaksi | Menyediakan antarmuka riwayat transaksi: daftar transaksi yang telah dilakukan, harga, status transaksi | UC09 |
...
| C31 | PengontrolTransaksi  | Mengelola logika transaksi keuangan, konektivitas  sistem pembayaran, validasi pembayaran, dan pembaruan status pembayaran, dan pencairan dana | UC09, UC12 |
| C32 | MetodePembayaran | Merepresentasikan pilihan metode pembayaran yang tersedia bagi pelanggan | UC09 |
| C33 | RiwayatTransaksi | Menyimpan Informasi Jasa yang telah dipesan beserta status pengerjaannya. | UC09, UC10 |
