...
| C04 | Portofolio | *Menyimpan karya, proyek, dan pengalaman kerja yang diunggah oleh Penyedia Jasa  | UC03 |
| C05 | Jasa | Menyimpan Informasi Jasa yang ditawarkan (Harga, deskripsi, dan durasi pengerjaan) | UC04, UC06 |
| C06 | *Bookmark* | menyimpan informasi jasa yang menarik bagi pengguna | UC07 |
| C07 | *ChatRoom* | Menyediakan sesi komunikasi antar dua atau lebih pengguna | UC08, UC16 |
| C08 | Pesanan | Menyimpan informasi jasa (brief) yang dipesan pengguna dan konfirmasi Penyedia Jasa | UC09, UC10 |
| C09 | MetodePembayaran | Merepresentasikan pilihan metode pembayaran yang tersedia bagi pelanggan | UC09 |
| C10 | RiwayatTransaksi | Menyimpan Informasi Jasa yang telah dipesan beserta status pengerjaannya. | UC09, UC10 |
| C11 | ProdukAkhir| Menyimpan hasil produk akhir yang dikerjakan Penyedia Jasa untuk diperiksa oleh (Pengguna Jasa).  | UC11, UC12 |
| C12 | PengajuanRevisi | Menyimpan Permintaan Perbaikan dari Pengguna Jasa saat pekerjaan belum sesuai | UC12 |
| C13 | PencairanDana | Menyimpan transaksi pelepasan  dana dari sistem menuju Penyedia Jasa setelah konfirmasi disetujui  | UC12 |
| C14 | TiketLaporan | Menyimpan keluhan, kendala, bukti, dan aduan pengguna untuk ditinjau oleh Admin.  | UC13 |
| C15 | Ulasan | Menyimpan feedback dan rating oleh Pengguna Jasa terhadap jasa yang telah dipesan  | UC14 |
| C16 | TanggapanLaporan | Mencatat balasan, analisis internal, dan keputusan peninjauan terkait laporan tersebut. | UC15 |
