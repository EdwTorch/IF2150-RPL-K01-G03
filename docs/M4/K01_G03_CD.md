...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| C03 | PenggunaJasa | Menyimpan Profil umum pengguna jasa yang sedang melihat informasi jasa |
| C12 | Jasa | Menyimpan informasi spesifik dari jasa yang dipilih pengguna untuk dibaca informasinya |
| C14 | JasaController | Menangani alur logika penarikan data relasional detail jasa dari basis data |
