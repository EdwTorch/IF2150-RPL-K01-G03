...
| C02 | Pengguna (Penyedia Jasa) | Menyimpan Profil Detail dan Informasi Spesifik milik Penyedia Jasa, daftar penawaran jasa, mengumpulkan hasil pekerjaan, komunikasi dan mengumpulkan hasil revisi | UC01, UC02, UC03, UC04, UC08, UC10, UC11 |
...
| C12 | Jasa | Menyimpan Informasi Jasa yang ditawarkan (Harga, deskripsi, dan durasi pengerjaan) | UC04, UC06 |
...
| C14 | JasaController | Menangani proses pengisian deskripsi jasa, harga yang ditawarkan, pemasangan kategori, dan availability yang diatur Penyedia Jasa | UC04 |
...
| C45 | Ulasan | Menyimpan feedback dan rating oleh Pengguna Jasa terhadap jasa yang telah dipesan  | UC14 |
...
| C22 | ChatRoom | idChatRoom, idAnggota, riwayatPesan, waktuDibuat | tambahAnggota(), dapatkanRiwayatPesan() |
...
| C26 | Pesanan | idPesanan, idPenggunaJasa, idPenyediaJasa, idJasa, brief, totalBiaya, statusPesanan | dapatkanDetailPesanan(), setStatusDiproses(), setStatusSelesai() |
