...
| C39 | HalamanRequestRevisi | Menyediakan antarmuka revisi pekerjaan bagi pengguna: detai pekerjaan, input permintaan revisi, informasi mengenai kuota revisi, tombol ajukan revisi, pesan | UC12 |
...
<p align="center">
<img alt="Class Diagram UC01" src="./assets/diagram/UC03.png" width="70%">
</p>
<p align="center">
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C01 | Pengguna | idPengguna, nama, email | bukaChat(), kirimPesan() |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C03 | Pengguna (Pengguna Jasa) | idPenggunaJasa, nama, email | pilihJasa(), isiFormPemesanan(), pilihMetodePembayaran() |
...
<p align="center">
<img alt="Class Diagram UC01" src="./assets/diagram/UC10.png" width="70%">
</p>
<p align="center">
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C02 | Pengguna (Penyedia Jasa) | idPenyediaJasa, nama, email | bukaNotifikasiPesanan(), terimaPesanan(), tolakPesanan() |
...
<p align="center">
<img alt="Class Diagram UC01" src="./assets/diagram/UC11_Diagram_Class.jpg" width="70%">
</p>
<p align="center">
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C02 | Penyedia Jasa  *idPesanan, total, status* | *buatPesanan(), hitungTotal()* |
| C11 | LayananUploadFile | *daftarItem* | *tambahItem(), checkout()* |
| C35 | ProdukAkhir | | | 
| C36 | HalamanPengumpulan | *...* | *...* |
...
| C39 | HalamanRequestRevisi | Menyediakan antarmuka revisi pekerjaan bagi pengguna: detai pekerjaan, input permintaan revisi, informasi mengenai kuota revisi, tombol ajukan revisi, pesan | 
...
<p align="center">
<img alt="Class Diagram UC01" src="./assets/diagram/UC12_Diagram_Class.jpg" width="70%">
</p>
<p align="center">
...
<p align="center">
<img alt="Class Diagram UC01" src="./assets/diagram/UC13_Diagram_Class.jpg" width="70%">
</p>
<p align="center">
<i>Gambar 2. Diagram Kelas Use Case UC01</i>
</p>
