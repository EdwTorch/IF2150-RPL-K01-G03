...
| C49 | TanggapanLaporan | Mencatat balasan, analisis internal, dan keputusan peninjauan terkait laporan tersebut. | UC15,16 |
...
| C23 | ChatRoom | idChatRoom, idAnggota, riwayatPesan, waktuDibuat | getRiwayatPesan(), sendNotifikasiPesan() |
