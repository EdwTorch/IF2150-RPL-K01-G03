...
| C02      | Pengguna(Penyedia Jasa) | -                                                                       | -                                                                |
| C03      | Pengguna(Pengguna Jasa) | pemilikJasa, email, noTelepon, password, kategoriJasa, namaJasa, alamat | -                                                                |
...
| ID Kelas | Nama Kelas               | Atribut                           | Metode/Operasi                                                               |
|----------|--------------------------|-----------------------------------|------------------------------------------------------------------------------|
| C02      | Pengguna (Penyedia Jasa) | pengalaman, prestasi              | isiPortofolio(), unggahPortofolio()                                          |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C03 | Pengguna (Pengguna Jasa) | idPenggunaJasa, nama, profilDetail | pilihJasa(), isiFormPemesanan(), pilihMetodePembayaran() |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C02 | Pengguna (Penyedia Jasa) | idPenyediaJasa, nama, profilDetail, daftarPenawaranJasa | bukaNotifikasiPesanan(), terimaPesanan(), tolakPesanan() |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| C02 | Penyedia Jasa | Menyimpan Profil Detail dan Informasi Spesifik milik Penyedia Jasa, daftar penawaran jasa, mengumpulkan hasil pekerjaan, dan mengumpulkan hasil revisi |
| C11 | LayananUploadFile | Menangani proses *upload* berkas berupa dokumen atau media ke dalam server, dan memberikan status penanganan prosesnya |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C02 | Pengguna (Penyedia Jasa) | idPenyediaJasa, nama, profilDetail, daftarJasa | kumpulkanProdukAkhir(), kumpulkanRevisi(), lihatStatusPengerjaan() |
| C11 | LayananUploadFile | statusProses, outputpath | isDeliverablesValid(), prosesUpload(), getStatusProses(), savetodatabase() |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C02 | Penyedia Jasa | idPenyediaJasa, nama, profilDetail, daftarJasa |  | 
| C03 | Pengguna (Pengguna Jasa) | idPengguna, nama, idPesanan, statusKonfirmasi | lihatStatusPengerjaan(), getDeliverables(), selesaikanPesanan(), ajukanRevisi()  |
| C31 | PengontrolTransaksi  | statusKonfirmasi, statusPencairanDana, lokasiPencairanDana | isTransactionValid(), cairkanDana(), getStatusPencairan() |
...
| C38 | PengajuanRevisi | deskripsiRevisi, jmlRevisiTersedia,  | |
| C39 | HalamanRequestRevisi |  |  |
| C40 | RevisiHandler |  |  |
| C41 | PencairanDana |  | |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| C02 | Pengguna (Penyedia Jasa) | Menyimpan Profil Detail dan Informasi Spesifik milik Penyedia Jasa, daftar penawaran jasa, mengumpulkan hasil pekerjaan, dan mengumpulkan hasil revisi |
| C03 | Pengguna (Pengguna Jasa) | Menyimpan Profil umum, pencarian jasa, dan pemesanan jasa, pengajuan revisi, komunikasi antar penjual ataupun mediasi, mengonfirmasi pesanan dan pengajuan revisi, melaporkan pengguna jika dibutuhkan, dan memberi ulasan |
...
<p align="center">
<img alt="Class Diagram UC13" src="./assets/diagram/UC13_Diagram_Class.jpg" width="70%">
</p>
<p align="center">
