...
| C24 | HalamanChat | Menyediakan antarmuka ruang obrolan: riwayat pesan, input pesan, kirim pesan, pesan error/gagal terkirim, notifikasi pesan | UC08 |
| C25 | LayananPesanInstan | Mengelola logika komunikasi  seperti, membuat sesi ChatRoom, validasi input pesan, penyimpanan ke dalam basis data, dan status baca pesan | UC08 |
| C26 | LayananNotifikasiChat | Mengirimkan notifikasi atau pop-up kepada lawan bicara saat pesan masuk | UC08 |
| C27 | Pesanan | Menyimpan informasi jasa (brief) yang dipesan pengguna dan konfirmasi Penyedia Jasa | UC09, UC10, UC14 |
...
| C31 | PengontrolPesanan  | Menangani pembuatan pesanan baru, total biaya, dan mengatur status pesanan, dan menerima konfirmasi Penyedia Jasa maupun pengguna jasa | UC09, UC10, UC12 |
...
| C36 | ProdukAkhir| Menyimpan hasil produk akhir yang dikerjakan Penyedia Jasa untuk diperiksa oleh (Pengguna Jasa).  | UC11, UC12 |
...
| C43 | TiketLaporan | Menyimpan keluhan, kendala, bukti, dan aduan pengguna untuk ditinjau oleh Admin.  | UC13 |
| C44 | HalamanPelaporan | Menyediakan antarmuka untuk melaporkan pengguna: form laporan, pilihan kategori pelanggaran, input deskripsi pelanggaran, upload bukti, tombol kirim laporan, status laporan, nomor tiket, pesan error, dan tanggapan laporan. | UC13, UC15 |
...
| C49 | TanggapanLaporan | Mencatat balasan, analisis internal, dan keputusan peninjauan terkait laporan tersebut. | UC15 |
...
| C52 | Admin | Meninjau laporan pengguna, mempertimbangkan sanksi yang diperlukan, membantu dalam proses mediasi, memberikan tanggapan terkait laporan pengguna | UC14, UC15, UC16 |
...
| C46 | Ulasan | idUlasan, idPesanan, rating, komentar, dokumentasi | simpanUlasan(), dapatkanUlasan |
...
| C12 | Jasa | idJasa, idPenyediaJasa, namaJasa, harga, statusAktif | simpanJasa(), dapatkanDetailJasa(), perbaruiJasa(), hapusJasa() |
| C20 | Bookmark | idBookmark, idPenggunaJasa, idJasa, waktuDisimpan** | simpanBookmark(), hapusBookmark() |
...
| C31 | PengontrolPesanan | idPengontrolPesanan | buatPesananBaru(), hitungTotalBiaya(), updateStatusPesanan() |
| C32 | PengontrolTransaksi | idPengontrolTransaksi | prosesPembayaran(), validasiPembayaran(), updateStatusPembayaran() |
...
| C27 | Pesanan | idPesanan, idPenggunaJasa, idPenyediaJasa, brief, statusPesanan | setStatusDiproses(), setStatusSelesai() |
| C31 | PengontrolPesanan | idPengontrolPesanan | konfirmasiPesanan(), updateStatusPesanan() |
| C34 | RiwayatTransaksi | idRiwayat, idPesanan, statusPengerjaan | perbaruiStatusPengerjaan() |
...
| C32 | PengontrolTransaksi  | - | isTransactionValid(), cairkanDana(), getStatusPencairan(), updateStatusPencairan() |
...
| C43 | TiketLaporan | idTiket, deskripsiLaporan, urlbukti, statusTiket, TanggapanAdmin, | setIdTiket(), getIdTiket(), setURLBukti(), getURLBukti(), setStatusTiket, UpdateStatusTiket(), getStatusTicket(), setTanggapan(), getTanggapan()   |
...
| C45 | LaporanHandler  | - | validasiFormatLaporan(), createTiket(), getStatusTiket(), kirimNotifAdmin(), simpanData(), banPengguna(), skorsPengguna(), kirimTanggapan(), saveTanggapan(), saveLaporan() | 
...
| C27 | Pesanan | idPesanan, idPenyediaJasa, statusPesanan | cekStatusPesanan(), getDetailPesanan() |
| C30 | HalamanRiwayatTransaksi | daftarPesananSelesai | tampilkanRiwayatTransaksi(), klikBeriUlasan() |
| C32 | PengontrolTransaksi | - | getStatusTransaksiSelesai() |
| C34 | RiwayatTransaksi | idRiwayat, idPesanan, statusTransaksi | getDataRiwayat() |
| C46 | Ulasan | idUlasan, idPesanan, idPenyediaJasa, ratingBintang, komentar, urlDokumentasi | simpanUlasan(), getDetailUlasan() |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C43 | TiketLaporan | idTiket, kategoriPelanggaran, deskripsiMasalah, lampiranBukti, statusTiket | getDetailTiket(), setStatusLaporan() |
| C44 | HalamanPelaporan | tanggapanAdmin | tampilkanTanggapanLaporan() |
| C45 | LaporanHandler | - | inputTindakan(), terapkanSanksi(), perbaruiStatusTiket() |
| C49 TanggapanLaporan | idTanggapan, idTiket, jenisTindakan, catatanTanggapan | catatKeputusanTindakan(), getDetailTanggapan() |
| C52 | Admin | idAdmin, nama | bukaTiketLaporan(), pilihJenisTindakan(), selesaikanLaporan(), mulaiMediasi() |
...
| :--- | :--- | :--- | :--- |
| C43 | TiketLaporan | idTiket, kategoriPelanggaran, deskripsiMasalah, lampiranBukti, statusTiket | getDetailTiket(), setStatusLaporan() |
| C45 | LaporanHandler | - | terapkanSanksi(), perbaruiStatusTiket() |
...
| C52 | Admin | idAdmin, nama | mulaiMediasi(), kirimPesanMediasi(), pilihJenisTindakan(), akhiriMediasi() |
