...
| :--- | :--- | :--- | :--- |
| C01 | Pengguna | Menyimpan data diri pengguna, informasi akun, dan kredensial akun | UC01, UC02 |
| C02 | Pengguna (Penyedia Jasa) | Menyimpan Profil Detail dan Informasi Spesifik milik Penyedia Jasa, daftar penawaran jasa, mengumpulkan hasil pekerjaan, komunikasi dan mengumpulkan hasil revisi | UC01, UC02, UC03, UC04, UC06, UC08, UC10, UC11 |
| C03 | Pengguna (Pengguna Jasa) | Menyimpan Profil umum, pencarian jasa, dan pemesanan jasa, pengajuan revisi, komunikasi antar penjual ataupun mediasi, mengonfirmasi pesanan dan pengajuan revisi, melaporkan pengguna jika dibutuhkan, dan memberi ulasan | UC01, UC02, UC05,UC06, UC07, UC08, UC09, UC12, UC13, UC14 |
...
| C05 | Layanan Registrasi | Memproses validasi pengisian data diri akun pengguna | UC01 |
...
| C19 | *Bookmark* | menyimpan informasi jasa yang menarik bagi pengguna | UC07 |
| C20 | HalamanBookmark |  Menampilkan antarmuka dalam bookmark: daftar jasa tersimpan, pilihan hapus bookmark, notifikasi berhasil disimpan/dihapus | UC07 |
| C21 |  PengontrolBookmark |  Menangani penambahan dan pengurangan jasa yang disimpan pengguna | UC07 |
| C22 | *ChatRoom* | Menyediakan sesi komunikasi antar dua atau lebih pengguna | UC08, UC16 |
| C23 | HalamanChat | Menyediakan antarmuka ruang obrolan: riwayat pesan, input pesan, kirim pesan, pesan error/gagal terkirim, notifikasi pesan | UC08 |
| C24 | LayananPesanInstan | Mengelola logika komunikasi  seperti, membuat sesi ChatRoom, validasi input pesan, penyimpanan ke dalam basis data, dan status baca pesan | UC08 |
| C25 | LayananNotifikasiChat | Mengirimkan notifikasi atau pop-up kepada lawan bicara saat pesan masuk | UC08 |
| C26 | Pesanan | Menyimpan informasi jasa (brief) yang dipesan pengguna dan konfirmasi Penyedia Jasa | UC09, UC10, UC14 |
| C27 | HalamanPemesanan | Menyediakan antarmuka pemesanan: detail pemesanan yang dipilih, harga, tombol pesan | UC09 |
| C28 | HalamanPembayaran | Menyediakan antarmuka pembayaran: total harga, pilihan metode pembayaran, tombol bayar, status pembayaran, pesan error | UC09 |
| C29 | HalamanRiwayatTransaksi | Menyediakan antarmuka riwayat transaksi: daftar transaksi yang telah dilakukan, harga, status transaksi | UC09, UC14 |
| C30 | PengontrolPesanan  | Menangani pembuatan pesanan baru, total biaya, dan mengatur status pesanan, dan menerima konfirmasi Penyedia Jasa maupun pengguna jasa | UC09, UC10, UC12 |
| C31 | PengontrolTransaksi  | Mengelola logika transaksi keuangan, konektivitas  sistem pembayaran, validasi pembayaran, dan pembaruan status pembayaran, dan pencairan dana | UC09, UC12, UC14 |
| C32 | MetodePembayaran | Merepresentasikan pilihan metode pembayaran yang tersedia bagi pelanggan | UC09 |
| C33 | RiwayatTransaksi | Menyimpan Informasi Jasa yang telah dipesan beserta status pengerjaannya. | UC09, UC10, UC14 |
| C34 | HalamanKonfirmasi | Menyediakan antarmuka konfirmasi pesanan: daftar pesanan, pilihan tolak/terima pesanan, status pesanan | UC10 |
| C35 | ProdukAkhir| Menyimpan hasil produk akhir yang dikerjakan Penyedia Jasa untuk diperiksa oleh (Pengguna Jasa).  | UC11, UC12 |
| C36 | HalamanPengumpulan | Menyediakan antarmuka pengumpulan pesanan: upload gambar/dokumen/link pengerjaan, deskripsi hasil, tombol kirim, pesan error | UC11 |
| C37 | HalamanDeliverables | Menyediakan antarmuka pengumpulan dari sisi pengguna: daftar hasil pekerjaan, tampilan hasil pekerjaan, status pekerjaan, tombol revisi, tombol konfirmasi selesai, pesan error | UC12 |
| C38 | PengajuanRevisi | Menyimpan Permintaan Perbaikan dari Pengguna Jasa saat pekerjaan belum sesuai | UC12 |
| C39 | HalamanRequestRevisi | Menyediakan antarmuka revisi pekerjaan bagi pengguna: detail pekerjaan, input permintaan revisi, informasi mengenai kuota revisi, tombol ajukan revisi, pesan | UC12 |
| C40 | RevisiHandler |  Menangani logika pengajuan revisi, seperti validasi jumlah revisi, kelengkapan deskripsi perbaikan yang diajukan, pengiriman informasi revisi pada Penyedia Jasa, dan notifikasi pada Penyedia Jasa | UC12 |
| C41 | PencairanDana | Menyimpan transaksi pelepasan  dana dari sistem menuju Penyedia Jasa setelah konfirmasi disetujui  | UC12 |
| C42 | TiketLaporan | Menyimpan keluhan, kendala, bukti, dan aduan pengguna untuk ditinjau oleh Admin.  | UC13 |
| C43 | HalamanPelaporan | Menyediakan antarmuka untuk melaporkan pengguna: form laporan, pilihan kategori pelanggaran, input deskripsi pelanggaran, upload bukti, tombol kirim laporan, status laporan, nomor tiket, pesan error, dan tanggapan laporan. | UC13, UC15 |
| C44 | LaporanHandler  | Menangani proses pengisian laporan, seperti validasi struktur laporan (judul, deskripsi, dan bukti), pembuatan tiket laporan, dan pengiriman notifikasi pada admin, mengambil data laporan, mencatat tanggapan admin, memperbarui status laporan, eksekusi sanksi, dan mengubah status akun terlapor | UC13, UC15 |
| C45 | Ulasan | Menyimpan feedback dan rating oleh Pengguna Jasa terhadap jasa yang telah dipesan  | UC06, UC14 |
| C46 | HalamanUlasan | Menyediakan antarmuka ulasan bagi pengguna: rating, input komentar, upload dokumentasi, tombol kirim ulasan, pesan error, notifikasi ulasan terkirim | UC14 |
| C47 | UlasanHandler  | Menangani proses pengisian laporan, validasi kelengkapan pengisian, dan penyimpanan data pada basis data server. | UC14 |
| C48 | TanggapanLaporan | Mencatat balasan, analisis internal, dan keputusan peninjauan terkait laporan tersebut. | UC15 |
| C49 | HalamanPengajuanMediasi  | Menyediakan antarmuka pengajuan mediasi: detail pelaporan, status mediasi, tombol ajukan mediasi, pesan error. | UC16 |
| C50 | MediasiHandler  | Menangani permintaan mediasi, dan membuka RoomChat berisikan admin, penyedia jasa, dan pengguna jasa. | UC16
| C51 | Admin | Meninjau laporan pengguna, mempertimbangkan sanksi yang diperlukan, membantu dalam proses mediasi, memberikan tanggapan terkait laporan pengguna | UC14, UC15, UC16 |
| C52 | HalamanJasa | Menyediakan antarmuka untuk menampilkan informasi lengkap listing jasa: deskripsi, paket harga, profil penyedia, dan ulasan. | UC06 |
...
|----------|--------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| C01      | Pengguna                 | Menyimpan data diri pengguna, informasi akun, dan kredensial akun                                                                                                                                                           |
| C02      | PenyediaJasa | Menyimpan Profil Detail dan Informasi Spesifik milik Penyedia Jasa, daftar penawaran jasa, mengumpulkan hasil pekerjaan, komunikasi dan mengumpulkan hasil revisi                                                           |
| C03      | PenggunaJasa | Menyimpan Profil umum, pencarian jasa, dan pemesanan jasa, pengajuan revisi, komunikasi antar penjual ataupun mediasi, mengonfirmasi pesanan dan pengajuan revisi, melaporkan pengguna jika dibutuhkan, dan memberi ulasan  |
...
<p align="center">
<img alt="Class Diagram UC01" src="./assets/diagram/UC01(2).png" width="70%">
</p>
<p align="center">
...
|----------|-------------------------|-------------------------------------------------------------------------|------------------------------------------------------------------|
| C01      | Pengguna                | nama, email, noTelepon, password                                        | buatAkun(), simpanAkun()                                         |
| C02      | PenyediaJasa | -                                                                       | -                                                                |
| C03      | PenggunaJasa | pemilikJasa, email, noTelepon, password, kategoriJasa, namaJasa, alamat | -                                                                |
...
<p align="center">
<img alt="Class Diagram UC02" src="./assets/diagram/UC02(2).png" width="70%">
</p>
<p align="center">
...
| ID Kelas | Nama Kelas               | Atribut                               | Metode/Operasi                              |
|----------|--------------------------|---------------------------------------|---------------------------------------------|
| C01      | Pengguna                 | email, password, noTelepon            | login()                                     |
| C02      | PenyediaJasa | -                                     | -                                           |
| C03      | PenggunaJasa | -                                     | -                                           |
...
<p align="center">
<img alt="Class Diagram UC03" src="./assets/diagram/UC03(2).png" width="70%">
</p>
<p align="center">
...
| ID Kelas | Nama Kelas               | Atribut                           | Metode/Operasi                                                               |
|----------|--------------------------|-----------------------------------|------------------------------------------------------------------------------|
| C02      | PenyediaJasa | pengalaman, prestasi              | isiPortofolio(), unggahPortofolio()                                          |
...
| C10      | PengontrolPortofolio     | -                                 | validasiData(), prosesPortofolio(), prosesSimpanPortofolio()                 |
| C11      | LayananUploadFile        | -                                 | uploadFile(), prosesUpload()                                                 |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C02 | PenyediaJasa | idPenyediaJasa, nama, profilDetail, daftarPenawaranJasa | tambahPenawaranJasa() |
| C11 | LayananUploadFile | - | prosesUpload(), uploadFile(), validasiFormatUkuran() |
...
| C14 | JasaController | - | validasiDataJasa(), simpanPenawaranJasa() |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C03 | PenggunaJasa | idPenggunaJasa, nama, profilDetail, | cariJasa(), gunakanFilter() |
| C12 | Jasa | idJasa, namaJasa, deskripsi, kategori, harga, ratingJasa | simpanJasa(), dapatkanDetailJasa(), perbaruiJasa(), hapusJasa() |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| C02 | Pengguna (Penyedia Jasa) | Menyimpan Profil Detail dan Informasi Spesifik milik Penyedia Jasa, daftar penawaran jasa, mengumpulkan hasil pekerjaan, komunikasi dan mengumpulkan hasil revisi |
| C03 | Pengguna (Pengguna Jasa) | Menyimpan Profil umum, pencarian jasa, dan pemesanan jasa, pengajuan revisi, komunikasi antar penjual ataupun mediasi, mengonfirmasi pesanan dan pengajuan revisi, melaporkan pengguna jika dibutuhkan, dan memberi ulasan |
| C12 | Jasa | Menyimpan Informasi Jasa yang ditawarkan (Harga, deskripsi, dan durasi pengerjaan) |
...
| C45 | Ulasan | Menyimpan feedback dan rating oleh Pengguna Jasa terhadap jasa yang telah dipesan |
| C52 | HalamanDetailJasa | Menyediakan antarmuka untuk menampilkan informasi lengkap listing jasa: deskripsi, paket harga, profil penyedia, dan ulasan. |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C02 | PenyediaJasa | idPenyediaJasa, nama, profilDetail | dapatkanProfilDetail() |
| C03 | PenggunaJasa | idPenggunaJasa, nama, profilDetail | bukaDetailJasa() |
| C12 | Jasa | idJasa, idPenyediaJasa, namaJasa, harga, statusAktif | simpanJasa(), dapatkanDetailJasa(), perbaruiJasa(), hapusJasa() |
| C14 | JasaController | - | ambilDetailJasa() |
| C45 | Ulasan | idUlasan, idPesanan, rating, komentar, dokumentasi | simpanUlasan(), dapatkanUlasan |
| C52 | HalamanDetailJasa | tampilanDeskripsi, tampilanHarga, infoProfilPenyedia, tampilanRiwayatUlasan, pesanError | tampilkanDetailJasa(), tampilkanPesanError() |
...
| C03 | Pengguna (Pengguna Jasa) | Menyimpan Profil umum, pencarian jasa, dan pemesanan jasa, pengajuan revisi, komunikasi antar penjual ataupun mediasi, mengonfirmasi pesanan dan pengajuan revisi, melaporkan pengguna jika dibutuhkan, dan memberi ulasan |
| C12 | Jasa | Menyimpan Informasi Jasa yang ditawarkan (Harga, deskripsi, dan durasi pengerjaan) |
| C19 | Bookmark | menyimpan informasi jasa yang menarik bagi pengguna |
| C20 | HalamanBookmark | Menampilkan antarmuka dalam bookmark: daftar jasa tersimpan, pilihan hapus bookmark, notifikasi berhasil disimpan/dihapus |
| C21 | PengontrolBookmark | Menangani penambahan dan pengurangan jasa yang disimpan pengguna |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C03 | PenggunaJasa | idPenggunaJasa, nama, profilDetail, daftarBookmark | bukaDaftarBookmark() |
| C12 | Jasa | idJasa, idPenyediaJasa, namaJasa, harga, statusAktif | simpanJasa(), dapatkanDetailJasa(), perbaruiJasa(), hapusJasa() |
| C19 | Bookmark | idBookmark, idPenggunaJasa, idJasa, waktuDisimpan** | simpanBookmark(), hapusBookmark() |
| C20 | HalamanBookmark | daftarJasaTersimpan, ikonBookmarkAktif, ikonBookmarkNonaktif, tombolHapusBookmark | tampilkanDaftarTersimpan(), klikIkonBookmark(), klikIkonHapus(), tampilkanNotifikasi() |
| C21 | PengontrolBookmark | - | tambahDataBookmark(), hapusDataBookmark(), ambilDaftarBookmarkPengguna() |
...
| :--- | :--- | :--- |
| C01  | Pengguna                 | Menyimpan data diri pengguna, informasi akun, dan kredensial akun                                                                                                                                                   |
| C02  | Penyedia Jasa | Menyimpan Profil Detail dan Informasi Spesifik milik Penyedia Jasa, daftar penawaran jasa, mengumpulkan hasil pekerjaan, komunikasi dan mengumpulkan hasil revisi                                                          |
| C03  | Pengguna Jasa	 | Menyimpan Profil umum, pencarian jasa, dan pemesanan jasa, pengajuan revisi, komunikasi antar penjual ataupun mediasi, mengonfirmasi pesanan dan pengajuan revisi, melaporkan pengguna jika dibutuhkan, dan memberi ulasan |
| C22  | ChatRoom                 | Menyediakan sesi komunikasi antar dua atau lebih pengguna                                                                                                                                                                  |
| C23  | HalamanChat              | Menyediakan antarmuka ruang obrolan: riwayat pesan, input pesan, kirim pesan, pesan error/gagal terkirim, notifikasi pesan                                                                                                 |
| C24  | LayananPesanInstan       | Mengelola logika komunikasi seperti, membuat sesi ChatRoom, validasi input pesan, penyimpanan ke dalam basis data, dan status baca pesan                                                                                   |
| C25  | LayananNotifikasiChat    | Mengirimkan notifikasi atau pop-up kepada lawan bicara saat pesan masuk            |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C01 | Pengguna | idPengguna, nama, profilDetail | bukaChat(), kirimPesan() |
| C22 | ChatRoom | idChatRoom, idAnggota, riwayatPesan, waktuDibuat | getRiwayatPesan() |
| C23 | HalamanChat | idSesiChat, inputPesan, statusKoneksi | tampilkanMenuChat(), tampilkanRiwayatPesan(), inputPesan(), tombolKirimTerklik(), tampilkanPesanError(), tampilkanStatusBelumTerkirim() |
| C24 | LayananPesanInstan | idLayanan | buatSesiChat(), validasiInputPesan(), kirimPesan(), simpanKeDatabase(), updateStatusBaca() |
| C25 | LayananNotifikasiChat | idNotifikasi | kirimNotifikasiPesan(), tampilkanPopUpNotifikasi() |
### 4.2.9 Use Case UC09
...
| :--- | :--- | :--- |
| C03  | Pengguna Jasa	 | Menyimpan Profil umum, pencarian jasa, dan pemesanan jasa, pengajuan revisi, komunikasi antar penjual ataupun mediasi, mengonfirmasi pesanan dan pengajuan revisi, melaporkan pengguna jika dibutuhkan, dan memberi ulasan |
| C26  | Pesanan                  | Menyimpan informasi jasa (brief) yang dipesan pengguna dan konfirmasi Penyedia Jasa                                                                                                                                        |
| C27  | HalamanPemesanan         | Menyediakan antarmuka pemesanan: detail pemesanan yang dipilih, harga, tombol pesan                                                                                                                                        |
| C28  | HalamanPembayaran        | Menyediakan antarmuka pembayaran: total harga, pilihan metode pembayaran, tombol bayar, status pembayaran, pesan error                                                                                                     |
| C29  | HalamanRiwayatTransaksi	  | Menyediakan antarmuka riwayat transaksi: daftar transaksi yang telah dilakukan, harga, status transaksi                                                                                                                    |
| C30  | PengontrolPesanan        | Menangani pembuatan pesanan baru, total biaya, dan mengatur status pesanan, dan menerima konfirmasi Penyedia Jasa maupun pengguna jasa                                                                                     |
| C31  | PengontrolTransaksi      | Mengelola logika transaksi keuangan, konektivitas sistem pembayaran, validasi pembayaran, dan pembaruan status pembayaran, dan pencairan dana                                                                              |
| C32  | MetodePembayaran         | Merepresentasikan pilihan metode pembayaran yang tersedia bagi pelanggan                                                                                                                                                   |
| C33  | RiwayatTransaksi         | Menyimpan Informasi Jasa yang telah dipesan beserta status pengerjaannya.|

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC09" src="./assets/diagram/UC09.png" width="70%">
</p>
<p align="center">
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C03 | PenggunaJasa | idPenggunaJasa, nama, profilDetail | pilihJasa(), isiFormPemesanan(), pilihMetodePembayaran() |
| C26 | Pesanan | idPesanan, idPenggunaJasa, idPenyediaJasa, idJasa, brief, totalBiaya, statusPesanan | getDetailPesanan(), setStatusDiproses(), setStatusSelesai() |
| C27 | HalamanPemesanan | idJasaDipilih, briefPemesanan | tampilkanFormPemesanan(), inputBriefPemesanan(), tombolPesanTerklik() |
| C28 | HalamanPembayaran | totalHarga, idMetodePembayaran | tampilkanPilihanPembayaran(), tampilkanRincianPembayaran(), tombolBayarTerklik(), tampilkanNotifikasiBerhasil() |
| C29 | HalamanRiwayatTransaksi | idTransaksi | tampilkanRiwayatTransaksi() |
| C30 | PengontrolPesanan | idPengontrolPesanan | buatPesananBaru(), hitungTotalBiaya(), updateStatusPesanan() |
| C31 | PengontrolTransaksi | idPengontrolTransaksi | prosesPembayaran(), validasiPembayaran(), updateStatusPembayaran() |
| C32 | MetodePembayaran | idMetode, namaMetode, nomorRekeningVA | getDetailMetode() |
| C33 | RiwayatTransaksi | idRiwayat, idPesanan, tanggalTransaksi, statusTransaksi | simpanTransaksi() |
...
| C30 | PengontrolPesanan        | Menangani pembuatan pesanan baru, total biaya, dan mengatur status pesanan, dan menerima konfirmasi Penyedia Jasa maupun pengguna jasa                             |
| C33 | RiwayatTransaksi         | Menyimpan Informasi Jasa yang telah dipesan beserta status pengerjaannya.                                                                                          |
| C34 | HalamanKonfirmasi        | Menyediakan antarmuka konfirmasi pesanan: daftar pesanan, pilihan tolak/terima pesanan, status pesanan |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C02 | PenyediaJasa | idPenyediaJasa, nama, profilDetail, daftarPenawaranJasa | bukaNotifikasiPesanan(), terimaPesanan(), tolakPesanan() |
| C26 | Pesanan | idPesanan, idPenggunaJasa, idPenyediaJasa, brief, statusPesanan | setStatusDiproses(), setStatusSelesai() |
| C30 | PengontrolPesanan | idPengontrolPesanan | konfirmasiPesanan(), updateStatusPesanan() |
| C33 | RiwayatTransaksi | idRiwayat, idPesanan, statusPengerjaan | perbaruiStatusPengerjaan() |
| C34 | HalamanKonfirmasi | idPesanan, detailBrief | tampilkanDetailPesanan(), tombolTerimaTerklik(), tombolTolakTerklik(), tampilkanStatusPesanan() |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| C02 | PenyediaJasa | Menyimpan Profil Detail dan Informasi Spesifik milik Penyedia Jasa, daftar penawaran jasa, mengumpulkan hasil pekerjaan, dan mengumpulkan hasil revisi |
| C11 | LayananUploadFile | Menangani proses *upload* berkas berupa dokumen atau media ke dalam server, dan memberikan status penanganan prosesnya |
| C35 | ProdukAkhir | Menyimpan hasil produk akhir yang dikerjakan Penyedia Jasa untuk diperiksa oleh (Pengguna Jasa). |
| C36 | HalamanPengumpulan | Menyediakan antarmuka pengumpulan pesanan: upload gambar/dokumen/link pengerjaan, deskripsi hasil, tombol kirim, pesan error |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C02 | PenyediaJasa | idPenyediaJasa, nama, profilDetail, daftarJasa | kumpulkanProdukAkhir(), kumpulkanRevisi(), getStatusPengerjaan() |
| C11 | LayananUploadFile | - | isDeliverablesValid(), prosesUpload(), getStatusProses(), savetodatabase() |
| C35 | ProdukAkhir | idProdukAkhir, idPesanan, outputpath, deskripsiProdukAkhir, tanggalPengumpulan,  statusPemeriksaan, fileURL | simpanProdukAkhir(), updateStatusPengerjaan(), getDetailJasa() | 
| C36 | HalamanPengumpulan | deskripsiHasil, fileURL, tombolKirim, pesanError  | tampilkanFormPengumpulan(), inputDeskripsiHasil(), unggahDeliverables(), tampilkanPesanError(), kirimHasil(), inputLink(), tampilkanStatusPengiriman() |
...
| C03 | PenggunaJasa | Menyimpan Profil umum, pencarian jasa, dan pemesanan jasa, pengajuan revisi, komunikasi antar penjual ataupun mediasi, mengonfirmasi pesanan dan pengajuan revisi, melaporkan pengguna jika dibutuhkan, dan memberi ulasan |
| C31 | PengontrolTransaksi  | Mengelola logika transaksi keuangan, konektivitas sistem pembayaran, validasi pembayaran, dan pembaruan status pembayaran, dan pencairan dana |
| C37 | HalamanDeliverables | Menyediakan antarmuka pengumpulan dari sisi pengguna: daftar hasil pekerjaan, tampilan hasil pekerjaan, status pekerjaan, tombol revisi, tombol konfirmasi selesai, pesan error |
| C38 | PengajuanRevisi | Menyimpan Permintaan Perbaikan dari Pengguna Jasa saat pekerjaan belum sesuai | 
| C39 | HalamanRequestRevisi | Menyediakan antarmuka revisi pekerjaan bagi pengguna: detail pekerjaan, input permintaan revisi, informasi mengenai kuota revisi, tombol ajukan revisi, pesan | 
| C40 | RevisiHandler |  Menangani logika pengajuan revisi, seperti validasi jumlah revisi, kelengkapan deskripsi perbaikan yang diajukan, pengiriman informasi revisi pada Penyedia Jasa, dan notifikasi pada Penyedia Jasa | 
| C41 | PencairanDana | Menyimpan transaksi pelepasan  dana dari sistem menuju Penyedia Jasa setelah konfirmasi disetujui  |


#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC12" src="./assets/diagram/UC12_Diagram_Class.jpg" width="70%">
</p>
<p align="center">
<i>Gambar 4.12 Diagram Kelas Use Case UC01</i>
</p>
<br>
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C02 | PenyediaJasa | idPenyediaJasa, nama, profilDetail, daftarJasa | cekPengirimanDana(), getRevisi()| 
| C03 | PenggunaJasa | idPengguna, nama, idPesanan, statusKonfirmasi | getStatusPengerjaan(), getDeliverables(), selesaikanPesanan(), ajukanRevisi()  |
| C31 | PengontrolTransaksi  | - | isTransactionValid(), cairkanDana(), getStatusPencairan(), updateStatusPencairan() |
| C37 | HalamanDeliverables | deskripsiHasil, fileURL, tombolKonfirmasi, tombolRevisi, jumlahRevisi, pesanError, tombolBantuan, lampiranDeliverables | tampilkanDeliverables(), ajukanRevisi(), konfirmasiPesanan(), tampilkanError, panggilBantuan() |
| C38 | PengajuanRevisi | deskripsiRevisi, jmlRevisiTersedia, lampiranRevisi, idRevisi, idPesanan, statusPengerjaan | setStatusPengerjaan(), getStatusPengerjaan(), setDeskripsiRevisi(), getDeskripsiRevisi(), setjmlRevisi(), getjmlRevisi() setIdRevisi(), getIdPesanan(), getIdRevisi() |
| C39 | HalamanRequestRevisi | formRevisi, detailRevisi, kuotaRevisi, tombolRevisi, pesanUntukPenyedia  | tampilkanformRevisi(), tampilkanFieldPengisianRevisi(), tampilkanKuotaRevisi(), isTombolRevisiPressed(), tampilkanPesan()  |

| C41 | PencairanDana | Menyimpan transaksi pelepasan  dana dari sistem menuju Penyedia Jasa setelah konfirmasi disetujui  |
| C40 | RevisiHandler | - | isJumlahRevisiValid(), isDeskripsiComplete(), sendRevisi(), setNotifikasiRevisi(), updateStatusPengerjaan(), updateIdRevisi()  |
| C41 | PencairanDana | stateTransaksi, statePencairanDana | setKondisiTransaksi(), setPencairanDana() |
...
| C02 | PenyediaJasa | Menyimpan Profil Detail dan Informasi Spesifik milik Penyedia Jasa, daftar penawaran jasa, mengumpulkan hasil pekerjaan, dan mengumpulkan hasil revisi |
| C03 | PenggunaJasa | Menyimpan Profil umum, pencarian jasa, dan pemesanan jasa, pengajuan revisi, komunikasi antar penjual ataupun mediasi, mengonfirmasi pesanan dan pengajuan revisi, melaporkan pengguna jika dibutuhkan, dan memberi ulasan |
| C42 | TiketLaporan | Menyimpan keluhan, kendala, bukti, dan aduan pengguna untuk ditinjau oleh Admin.  
| C43 | HalamanPelaporan | Menyediakan antarmuka untuk melaporkan pengguna: form laporan, pilihan kategori pelanggaran, input deskripsi pelanggaran, upload bukti, tombol kirim laporan, status laporan, nomor tiket, pesan error, dan tanggapan laporan. | 
| C44 | LaporanHandler  | Menangani proses pengisian laporan, seperti validasi struktur laporan (judul, deskripsi, dan bukti), pembuatan tiket laporan, dan pengiriman notifikasi pada admin, mengambil data laporan, mencatat tanggapan admin, memperbarui status laporan, eksekusi sanksi, dan mengubah status akun terlapor |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C01 | Pengguna | statusAkun,sanksi| setStatusAkun(), setSanksi() | 
| C02 | PenyediaJasa | idPenyediaJasa, nama, profilDetail, daftarJasa | - |
| C03 | PenggunaJasa | idPenggunaJasa, nama, profilDetail, daftarPesanan | - |
| C42 | TiketLaporan | idTiket, deskripsiLaporan, urlbukti, statusTiket, TanggapanAdmin, | setIdTiket(), getIdTiket(), setURLBukti(), getURLBukti(), setStatusTiket, UpdateStatusTiket(), getStatusTicket(), setTanggapan(), getTanggapan()   |
| C43 | HalamanPelaporan | formLaporan, kategoriPelanggaran, deskripsiPelanggaran, kolomBukti, statusLaporan, noTiket, pesanError, tanggapanAdmin | tampilkanFormLaporan(), tampilkanOpsiKategoriPelanggaran(), tampilkanDeskripsiPelanggaran, tampilkanNomorTiket(), tampilkanPesanError(), tampilkanTanggapanAdmin(), tampilkanPesanError() | 
| C44 | LaporanHandler  | - | validasiFormatLaporan(), createTiket(), getStatusTiket(), kirimNotifAdmin(), simpanData(), banPengguna(), skorsPengguna(), kirimTanggapan(), saveTanggapan(), saveLaporan() | 
...
| C33 | RiwayatTransaksi | Menyimpan Informasi Jasa yang telah dipesan beserta status pengerjaannya |
| C45 | Ulasan | Menyimpan feedback dan rating oleh Pengguna Jasa terhadap jasa yang telah dipesan |
| C46 | HalamanUlasan | Menyediakan antarmuka ulasan bagi pengguna: rating, input komentar, upload dokumentasi, tombol kirim ulasan, pesan error, notifikasi ulasan terkirim |
| C47 | UlasanHandler | Menangani proses pengisian laporan, validasi kelengkapan pengisian, dan penyimpanan data pada basis data server |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C03 | PenggunaJasa | idPenggunaJasa, nama, profilDetail | klikBeriUlasan(), berikanPenilaian() |
| C26 | Pesanan | idPesanan, idPenyediaJasa, statusPesanan | cekStatusPesanan(), getDetailPesanan() |
| C29 | HalamanRiwayatTransaksi | daftarPesananSelesai | tampilkanRiwayatTransaksi(), klikBeriUlasan() |
| C31 | PengontrolTransaksi | - | getStatusTransaksiSelesai() |
| C33 | RiwayatTransaksi | idRiwayat, idPesanan, statusTransaksi | getDataRiwayat() |
| C45 | Ulasan | idUlasan, idPesanan, idPenyediaJasa, ratingBintang, komentar, urlDokumentasi | simpanUlasan(), getDetailUlasan() |
| C46 | HalamanUlasan | rating, teksKomentar, fileDokumentasi, pesanError | tampilkanFormUlasan(), inputRatingBintang(), inputKomentar(), unggahDokumentasi(), tampilkanPesanError(), tampilkanNotifikasiBerhasil() |
| C47 | UlasanHandler | - | validasiKelengkapanRating(), validasiFormatBerkas(), validasiPanjangKomentar(), prosesUlasan(), perbaruiRating() |
...
| C43 | HalamanPelaporan | Menyediakan antarmuka untuk melaporkan pengguna: form laporan, pilihan kategori pelanggaran, input deskripsi pelanggaran, upload bukti, tombol kirim laporan, status laporan, nomor tiket, pesan error, dan tanggapan laporan |
| C44 | LaporanHandler | Menangani proses pengisian laporan, seperti validasi struktur laporan (judul, deskripsi, dan bukti), pembuatan tiket laporan, dan pengiriman notifikasi pada admin, mengambil data laporan, mencatat tanggapan admin, memperbarui status laporan, eksekusi sanksi, dan mengubah status akun terlapor |
| C48 TanggapanLaporan | Mencatat balasan, analisis internal, dan keputusan peninjauan terkait laporan tersebut |
| C51 | Admin | Meninjau laporan pengguna, mempertimbangkan sanksi yang diperlukan, membantu dalam proses mediasi, memberikan tanggapan terkait laporan pengguna |

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC01" src="./assets/diagram/UC15.png" width="70%">
</p>
<p align="center">
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| C42 | TiketLaporan | idTiket, kategoriPelanggaran, deskripsiMasalah, lampiranBukti, statusTiket | getDetailTiket(), setStatusLaporan() |
| C43 | HalamanPelaporan | tanggapanAdmin | tampilkanTanggapanLaporan() |
| C44 | LaporanHandler | - | inputTindakan(), terapkanSanksi(), perbaruiStatusTiket() |
| C48 TanggapanLaporan | idTanggapan, idTiket, jenisTindakan, catatanTanggapan | catatKeputusanTindakan(), getDetailTanggapan() |
| C51 | Admin | idAdmin, nama | bukaTiketLaporan(), pilihJenisTindakan(), selesaikanLaporan(), mulaiMediasi() |
...
| C42 | TiketLaporan | Menyimpan keluhan, kendala, bukti, dan aduan pengguna untuk ditinjau oleh Admin |
| C44 | LaporanHandler | Menangani proses pengisian laporan, seperti validasi struktur laporan (judul, deskripsi, dan bukti), pembuatan tiket laporan, dan pengiriman notifikasi pada admin, mengambil data laporan, mencatat tanggapan admin, memperbarui status laporan, eksekusi sanksi, dan mengubah status akun terlapor |
| C49 | HalamanPengajuanMediasi | Menyediakan antarmuka pengajuan mediasi: detail pelaporan, status mediasi, tombol ajukan mediasi, pesan error |
| C50 | MediasiHandler | Menangani permintaan mediasi, dan membuka RoomChat berisikan admin, penyedia jasa, dan pengguna jasa |
| C51 | Admin | Meninjau laporan pengguna, mempertimbangkan sanksi yang diperlukan, membantu dalam proses mediasi, memberikan tanggapan terkait laporan pengguna |

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC01" src="./assets/diagram/UC16.png" width="70%">
</p>
<p align="center">
...
| :--- | :--- | :--- | :--- |
| C42 | TiketLaporan | idTiket, kategoriPelanggaran, deskripsiMasalah, lampiranBukti, statusTiket | getDetailTiket(), setStatusLaporan() |
| C44 | LaporanHandler | - | terapkanSanksi(), perbaruiStatusTiket() |
| C49 | HalamanPengajuanMediasi | detailPelaporan, riwayatPesan, opsiTindakan, pesanError | - |
| C50 | MediasiHandler | idSesiMediasi | inputTindakan(), akhiriMediasi(), tampilkanPesanError(), tampilkanNotifikasiSelesai() |
| C51 | Admin | idAdmin, nama | mulaiMediasi(), kirimPesanMediasi(), pilihJenisTindakan(), akhiriMediasi() |
